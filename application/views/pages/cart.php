<div class="column2">	
	...
	<table class ="cart_tab" align="center" cellpadding="10">
                        ...
                        ?>
                         <tr> <td></td><td> <form method="post" action="<?php echo base_url();?>gears" align="center"> <input type="submit" name="continue" value="Continue Shopping""> </form> </td> <td> <form method="post" action="<?php echo base_url();?>orders" > <input type="submit" name="submit" value="Place Order" class="cart_input" > </form> </td> </tr>
                   </table>
               </div>
